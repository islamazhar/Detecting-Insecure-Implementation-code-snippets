...
\begin{tabular}{|l|l|l|l|}
  ...
  \bottomrule
  \end{tabular}
  \caption{The 8 most insecure patterns found on code snippets.}
  \label{tab:insecure-patterns}
% }
\end{table}
%%%Insecure pattern
%\subsection{Insecure Patterns}
We will now summerize the 8 common insecure patterns our method aims to detect in the comming paragraphs and in Table~\ref{tab:insecure-patterns}. 
